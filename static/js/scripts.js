        ...
        $.getJSON(nowPlayingURL, function(nowPlayingData) {
            ...
            for (let i = 0; i < nowPlayingData.results.length; i++) {
                ...
                $.getJSON(thisMovieUrl, function(movieKey) {
                    ...
                    //var originalLanguage = nowPlayingData.results[i].original_language;
                    ...
                    nowPlayingHTML += '<div class="linkToTrailer"><a href="' + youtubeLink + '" target=_blank><span class="glyphicon glyphicon-play"></span>&nbspPlay trailer</a>' + '</div><br>';
                    nowPlayingHTML += '<div class="release">Release Date: ' + releaseDate + '</div><br>';
                    //nowPlayingHTML += '<div class="overview">Original Language:' + originalLanguage + '</div><br>';
        ...
        $.getJSON(getMoviesByGenreURL, function(genreData) {
            ...
            for (let i = 0; i < genreData.results.length; i++) {
                ...
                $.getJSON(thisMovieUrl, function(movieKey) {
                    ...
                    //var runtime = genreData.results[i].runtime;
                    ...
                    genreHTML += '<div class="linkToTrailer"><a href="' + youtubeLink + '" target=_blank><span class="glyphicon glyphicon-play"></span>&nbspPlay trailer</a>' + '</div><br>';
                    genreHTML += '<div class="release">Release Date: ' + releaseDate + '</div><br>';
                    //genreHTML += '<div class="overview">Runtime:' + runtime + '</div><br>';
        ...
        $.getJSON(searchMovieURL, function(movieSearchResults) {
            ...
            for (let i = 0; i < movieSearchResults.results.length; i++) {
                ...
                $.getJSON(thisMovieUrl, function(movieKey) {
                    ...
                    //var budget = movieSearchResults.results[i].budget;
                    ...
                    searchResultsHTML += '<div class="linkToTrailer"><a href="' + youtubeLink + '" target=_blank><span class="glyphicon glyphicon-play"></span>&nbspPlay trailer</a>' + '</div><br>';
                    ...
                    //searchResultsHTML += '<div class="overview">Budget: $ ' + budget + '</div><br>';
